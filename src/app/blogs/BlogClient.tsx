      ...
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-white">
        <div className="text-center space-y-4">
          <div className="relative">
            <div className="animate-spin rounded-full h-16 w-16 border-4 border-[#214B3F]/20 border-t-[#214B3F] mx-auto"></div>
            <Mountain className="h-6 w-6 text-[#214B3F] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2" />
          </div>
