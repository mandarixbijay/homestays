  ...
  return (
    <div className="space-y-2">
      ...
      <div className="relative">
        {/* Domain Preview */}
        <div className="absolute inset-y-0 left-0 flex items-center pl-3 pointer-events-none text-sm text-gray-500 dark:text-gray-400">
          .../blogs/
        </div>
      ...
      <div className="flex items-center justify-between text-xs">
        <span className={`${
          value.length > 60 ? 'text-orange-600 dark:text-orange-400' :
          value.length > 50 ? 'text-yellow-600 dark:text-yellow-400' :
      ...
      {value && validationResult.valid && (
        <div className="mt-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg border border-blue-200 dark:border-blue-800">
          <div className="text-xs text-gray-600 dark:text-gray-400 mb-1">Preview URL:</div>
