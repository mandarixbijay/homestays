...
const ImageInsertDialog: React.FC<ImageInsertDialogProps> = ({
 ...
 <ImageIcon className="h-5 w-5 text-[#1A403D]" />
 Insert Image
 </h3>
 <button
 onClick={onClose}
 ...
 disabled={uploading}
 className="w-full flex items-center justify-center gap-2 px-4 py-3 border-2 border-dashed border-gray-300 rounded-lg hover:border-[#1A403D] transition-colors disabled:opacity-50"
 >
 {uploading ? (
 <>
 <Loader2 className="h-5 w-5 animate-spin text-[#1A403D]" />
 ...
 className="w-full px-3 py-2 border border-gray-300 rounded-lg bg-white text-gray-900 focus:ring-2 focus:ring-[#1A403D]"
 ...
 disabled={!url || !alt}
 className="px-4 py-2 text-sm font-medium text-white bg-[#1A403D] hover:bg-[#1A403D] rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
 Insert Image
 </button>
 </div>
...
export const EnhancedRichTextEditor: React.FC<EnhancedRichTextEditorProps> = ({
 ...
 className="p-2 hover:bg-green-50 rounded transition-all hover:scale-110"
 ...
 title="Insert Link"
 >
 <Link2 className="h-4 w-4 text-[#1A403D] " />
 </button>
 </div>
 </div>
 ...
 <span className="text-xs text-gray-600 px-3 py-1 bg-white rounded-full">
 {wordCount} words
 </span>
 <button
 type="button"
 ...
 className="p-6 focus:outline-none prose prose-lg max-w-none min-h-[400px]"
 ...
 <button onClick={insertLink} className="px-4 py-2 bg-[#1A403D] text-white rounded">
 Insert
 </button>
 </div>
 </div>
