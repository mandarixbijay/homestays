          ...
          <div className="flex items-center justify-between flex-wrap gap-3">
            <div className="flex items-center gap-2 flex-wrap">
              ...
              <div className="flex items-center gap-1 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg p-1.5 shadow-sm border-2 border-blue-200">
                ...
                <button onClick={() => setShowLinkDialog(true)} className="p-2 bg-white hover:bg-blue-50 rounded transition" title="Link"><Link2 className="h-4 w-4 text-blue-600" /></button>
              </div>
            </div>

            <div className="flex items-center gap-3">
              <div className="px-4 py-2 bg-gradient-to-r from-blue-50 to-purple-50 rounded-xl border border-blue-200">
                <div className="text-xs font-bold text-blue-600">{wordCount} words</div>
              </div>
              <button
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
          <div className="bg-white rounded-2xl p-6 max-w-md w-full shadow-2xl">
            ...
            <div className="flex gap-3 justify-end">
              ...
              <button onClick={insertLink} className="px-4 py-2 bg-blue-600 text-white rounded-xl hover:bg-blue-700">Insert</button>
            </div>
          </div>
        </div>
      )}
