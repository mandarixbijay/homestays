...
export default function DestinationDetail({ destinationId }: DestinationDetailProps) {
 ...
 <p className="text-sm text-gray-600 ">ID: #{destination.id}</p>
 </div>
 </div>
 ...
 <p className="text-3xl font-bold text-[#224240] ">
 ...
 <Activity className="h-12 w-12 text-[#1A403D]/20" />
 </div>
 </div>
 </div>
 ...
 <p className="text-gray-900 text-lg">{destination.name}</p>
 )}
 </div>
 ...
 <p className="text-gray-600 ">{destination.description || 'No description'}</p>
 )}
 </div>
 ...
 <p className="text-gray-900 ">{destination.priority || 'Not set'}</p>
 )}
 </div>
 ...
 />
 <span className="text-sm text-gray-700 ">Mark as top destination</span>
 </label>
 ) : (
 <p className="text-gray-900 ">{destination.isTopDestination ? 'Yes' : 'No'}</p>
 )}
 </div>
 </div>
 </div>
 ...
 className="flex items-center gap-2 text-sm text-[#224240] hover:underline"
 >
 ...
 <h4 className="font-medium text-xs text-gray-900 line-clamp-1 flex-1">
 {homestay.name}
 </h4>
 ...
 <span className="font-semibold text-[#224240] ">
 ...
 <tr>
 <th className="px-3 py-2 text-left text-xs font-medium text-gray-600 ">Select</th>
 <th className="px-3 py-2 text-left text-xs font-medium text-gray-600 ">Homestay</th>
 <th className="px-3 py-2 text-left text-xs font-medium text-gray-600 ">Location</th>
 <th className="px-3 py-2 text-left text-xs font-medium text-gray-600 ">Rooms</th>
 ...
 <td className="px-3 py-2 text-xs font-semibold text-[#224240] ">
 {homestay.rooms && homestay.rooms.length > 0
 ? `${homestay.rooms[0]?.currency || 'NPR'} ${Math.min(...homestay.rooms.map(r => r.price || 0))}`
 : '-'}
 </td>
 ...
 <Home className="h-16 w-16 text-gray-400 mx-auto mb-4" />
 <h3 className="text-lg font-medium text-gray-900 mb-2">No homestays yet</h3>
 <p className="text-gray-600 mb-4">Add homestays to this destination to get started</p>
 <ActionButton
 ...
 <div className="p-4">
 <h4 className="font-medium text-gray-900 mb-1">{homestay.name}</h4>
 <p className="text-sm text-gray-600 mb-3">{homestay.location || homestay.address || 'No location'}</p>
