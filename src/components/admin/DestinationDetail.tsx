...
export default function DestinationDetail({ destinationId }: DestinationDetailProps) {
  ...
  useEffect(() => {
    ...
    loadHomestays({ page: 1, limit: 1000 }); // Load all homestays for selection
  }, []);
  ...
  }, [homestays, destination?.homestays, searchQuery, statusFilter, locationFilter]);
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    <div className="flex items-center justify-between">
                      <p className="text-sm text-gray-600 dark:text-gray-400">
                        {selectedHomestays.length} selected • {availableHomestays.length} available
                      </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 max-h-96 overflow-y-auto">
                    {homestaysLoading ? (
                      ...
                      <div className="col-span-full text-center py-12">
                        ...
                        <p className="text-gray-600 dark:text-gray-400">No homestays available</p>
                      </div>
                    ) : (
                      availableHomestays.map((homestay: any) => (
                        ...
                        >
                          {selectedHomestays.includes(homestay.id) && (
                            <div className="absolute top-2 right-2 w-6 h-6 bg-[#224240] rounded-full flex items-center justify-center">
                          ...
                          {homestay.mainImage ? (
                            ...
                            <div className="w-full h-32 bg-gray-200 dark:bg-gray-700 rounded-t-lg flex items-center justify-center">
